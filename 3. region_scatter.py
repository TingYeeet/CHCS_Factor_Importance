...
# 需要處理的資料夾設定
datasets = [
    {"input": "1-1_importance_upper/csv", "output": "3-1_region_scatter_upper"},
    {"input": "1-2_importance_lower/csv", "output": "3-2_region_scatter_lower"}
]
...
for data in datasets:
    ...
    print(f"\n🎯 完成資料夾 {input_folder} 的單區域最高相關性之因子散布圖輸出")
